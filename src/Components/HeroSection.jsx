    ...
    <div className="pt-24 pb-16 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="bg-emerald-600 rounded-3xl p-12 text-center text-white relative overflow-hidden">
          ...
          <Link to="/plant-diary-form" className="bg-white text-emerald-600 px-8 py-3 rounded-full hover:bg-emerald-50 transition transform hover:-translate-y-1 relative z-10">
            Get Started Now
          </Link>
        </div>
      </div>
