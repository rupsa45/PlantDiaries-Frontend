      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
          ...
          <p className="text-gray-600">
            Create personalized digital diaries tracking every milestone of your
            plants' lives.
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
          ...
          <p className="text-gray-600">
            Connect with a community of plant lovers, sharing your green
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
          ...
          <p className="text-gray-600">
            Access a comprehensive knowledge base with expert tips, care guides,
            and plant health insights.
          </p>
        </div>
      </div>
    </div>
